...
const createUser=async(req,res)=>{
    ...
    try{
        ...
        let senderData={
            ...
            text:`Hi ${response.name} thank you for Signin and partnering with Inte-Gemini to build our community.Do the login in inte gem and you are ready to rock 😉 Here is a Inte-Gem login link https://inte-gem.vercel.app/login and password ${password} keep it safe...`
        }
        transporter.sendMail(senderData)
